            ...
            searchingForUser || !roles || !newRoles ? <Spinner /> : (
              user ? (
                <>
                  ...
                  <p>Use roles to give pre-defined permissions to this user. To directly define access policies for this user, use the <Link to={`/instances/${instanceID}/settings/access-policies/manage`}>access policies</Link> page.</p>
